import { CAMERA } from '@katana/shared';
...
export class MouseLook {
  ...
  /** A left click on the world while playing: a katana swing. Consumed once per frame. */
  ...
  /** True once after a click that should throw a katana swing. */
  ...
  private readonly onMouseDown = (event: MouseEvent): void => {
    ...
    this.cursorFree = false;
    if (this.locked) {
      // Playing: a click on the world SWINGS THE KATANA.
