...
export class Toasts {
  ...
  show(text: string, tone: ToastTone = 'good'): void {
    ...
    toast.className = `ke-toast ke-toast--${tone} ke-outline`;
...
/** The single green hint line under the top centre. */
export class HintLine {
  ...
  constructor(parent: HTMLElement) {
    injectKatanaStyles();
    this.root = document.createElement('div');
    this.root.className = 'ke-hint ke-outline';
