...
import { LEADERBOARD_SIZE } from '@katana/shared';
...
/** The three boards on the back wall: Most Wins, Most Damage, Most Time. Fixed-length, written in place. */
...
export class GameState extends Schema {
  ...
  /** The forge stock in effect, and the seconds until the next restock. */
  @type('uint32') forgeRotation = 0;
  @type('uint16') forgeSecondsLeft = 0;
}
