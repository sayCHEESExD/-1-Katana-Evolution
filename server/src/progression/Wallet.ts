import { MAX_WINS } from '@katana/shared';
import type { PlayerState } from '../rooms/state/PlayerState.js';

/**
 * The ONE place Wins are added or removed.
 *
 * Stage reward pads and Bux grants add them (and the lifetime total the Total
 * Wins board ranks); katanas, forge items and eggs are BOUGHT with them
