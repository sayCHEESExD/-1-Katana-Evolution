import { LEADERBOARD_SIZE, handleFor } from '@katana/shared';
...
/**
 * The three boards on the back wall: Most Wins (earned, ever), Most Damage
 * (the server's damage-per-click figure) and Most Time (seconds played, ever).
 *
