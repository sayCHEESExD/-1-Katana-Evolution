/**
 * @katana/shared - the single source of truth for anything that must be
...
export * from './config/damage.js';
export * from './config/decor.js';
export * from './config/forge.js';
export * from './config/format.js';
export * from './config/handles.js';
export * from './config/health.js';
export * from './config/katanas.js';
...
export * from './config/stages.js';
export * from './config/teleport.js';
export * from './config/training.js';
